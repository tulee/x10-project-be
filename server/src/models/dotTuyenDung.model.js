    ...
    const agg = [
      {
        ...
        '$lookup': {
          ...
          'localField': 'yeu_cau_ung_tuyen.id_bai_test',
          'foreignField': '_id',
          'as': 'thong_tin_bai_test'
        }
      }, {
        '$unwind': {
          'path': '$thong_tin_bai_test',
          'preserveNullAndEmptyArrays': true
        }
      }, {
        '$group': {
          ...
          'ung_vien': {
            '$push': {
              ...
              'ten_bai_test': '$thong_tin_bai_test.ten_bai_test',
              'ma_bai_test': '$thong_tin_bai_test.ma_bai_test',
